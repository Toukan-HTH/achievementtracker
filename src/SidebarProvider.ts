    ...
    webviewView.webview.onDidReceiveMessage(async (data) => {
      switch (data.type) {
        ...
        case "testAchievement":{
          console.log("achievement opening...")
          MainPanel.createOrShow(this._context.extensionUri,this,data.tag);
          MainPanel.sendMessage(data.value);
        }
        ...
        case "resetStorage":{
          console.log("Resetting secret storage...");
          data.value.forEach(async (element: string) => {
            console.log("Removing value for... " + element);
            await this._secretStorage.delete(element);
          });
        }
